...
repos=(
    "https://github.com/deepa-vn/course-discovery.git"
    "https://github.com/deepa-vn/credentials.git"
    "https://github.com/deepa-vn/cs_comments_service.git"
    "https://github.com/deepa-vn/ecommerce.git"
    "https://github.com/deepa-vn/edx-e2e-tests.git"
    "https://github.com/deepa-vn/edx-notes-api.git"
    "https://github.com/deepa-vn/edx-platform.git"
    "https://github.com/deepa-vn/xqueue.git"
    "https://github.com/deepa-vn/edx-analytics-pipeline.git"
    "https://github.com/deepa-vn/registrar.git"
    "https://github.com/deepa-vn/frontend-app-gradebook.git"
    "https://github.com/deepa-vn/frontend-app-program-console.git"
    "https://github.com/deepa-vn/frontend-app-publisher.git"
)

ssh_repos=(
    "git@github.com:deepa-vn/course-discovery.git"
    "git@github.com:deepa-vn/credentials.git"
    "git@github.com:deepa-vn/cs_comments_service.git"
    "git@github.com:deepa-vn/ecommerce.git"
    "git@github.com:deepa-vn/edx-e2e-tests.git"
    "git@github.com:deepa-vn/edx-notes-api.git"
    "git@github.com:deepa-vn/edx-platform.git"
    "git@github.com:deepa-vn/xqueue.git"
    "git@github.com:deepa-vn/edx-analytics-pipeline.git"
    "git@github.com:deepa-vn/registrar.git"
    "git@github.com:deepa-vn/frontend-app-gradebook.git"
    "git@github.com:deepa-vn/frontend-app-program-console.git"
    "git@github.com:deepa-vn/frontend-app-publisher.git"
)

private_repos=(
    # Needed to run whitelabel tests.
    "https://github.com/deepa-vn/edx-themes.git"
)
